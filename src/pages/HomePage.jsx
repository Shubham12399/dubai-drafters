        ...
        <div className="w-full pb-4">
          ...
          <div>
            ...
            <div className="mt-2 relative">
              ...
              <img src={Icon1} alt="" className="relative z-0 w-[240px] -ml-8 -mb-4 select-none cursor-auto" />
              
              <div className="relative z-40 py-4 mt-2 md:py-6 mb-4 px-2 pl-4 md:pl-2 max-w-maxContent mx-1 md:m-0 md:pb-9 sm:!mx-auto md:rounded-none md:shadow-none border-[#ff621c] md:border-none rounded-xl md:bg-transparent before:block before:w-[200px] before:bg-white before:h-[17px] before:absolute before:top-0 before:left-0 before:z-[999] before:blur-sm">
...
after:h-[3px] after:bg-[#ff621c] after:rounded-lg md:after:hidden */}
          ...
          <Suspense>
            <TypeTours title={"Adventure"}></TypeTours>
            </Suspense>
          <Suspense>
            <TypeTours title={"Luxury"}></TypeTours>
            </Suspense>
          <Suspense>
            <TypeTours title={"Water"}></TypeTours>
            </Suspense>
        </div>
        {/* ----------------------------------Bottom Nav ---------------------------------------- */}
        <BottomNav></BottomNav>
...
// git add . >> git commit -m "lazy commit" >> git push origin main
