            ...
            <div className="relative py-4 md:py-6 mb-4 px-2 pl-4 md:pl-2 max-w-maxContent mx-1 md:m-0 md:pb-9 sm:!mx-auto md:rounded-none md:shadow-none border border-[#ff621c] md:border-none rounded-xl bg-white md:bg-transparent ">
                  <div className="max-w-[850px] mx-auto lg:mt-6 grid grid-cols-[40%_30%_30%] md:grid-cols-[repeat(3,_minmax(0,_1fr))_130px_130px] md:border border-[#08aca0] md:px-6 md:rounded-full md:py-7 md:!pr-0 gap-y-2 md:gap-x-0 md:!gap-0 " >
                      ...
                      <div className="hidden md:flex md:pl-7 md:border-r border-[#08aca0]  ">
                          ...
                          <span className="text-[10px] md:text-xs text-richblack-200 select-none cursor-pointer GTE_light block mt-1">Type Date</span>
                          </div>
                      </div>  
                      <div className=" hidden md:flex md:pl-7  ">
                          ...
                          <span className="text-[10px] md:text-xs text-richblack-200 select-none cursor-pointer GTE_light flex justify-between pr-1 mt-1 w-fit items-center ">1 Guest <GoChevronRight className="rotate-90 text-[10px] ml-12"></GoChevronRight></span>
                          </div>
                      </div>  
              ...
              {/* <h1 className="text-lg md:text-2xl font-medium">America</h1> */}
               ...
               <div className="my-3 mt-6 flex gap-x-2 md:gap-x-4 md:mt-6 overflow-auto hide-scrollbar"> 
                   <div className="min-w-[140px] w-[140px] h-[170px] sm:w-[160px] sm:h-[200px] md:w-[230px] md:h-[280px] rounded-lg overflow-hidden relative ">
                       ...
                       <div className="absolute w-full h-full bottom-0 left-0 flex items-end bg-gradient-to-b from-transparent via-transparent to-black"><h2 className="text-white text-[16px] pb-3 px-3 pl-4 w-full hover:text-[18px] transition-all md:text-xl md:hover:text-2xl GTE_light">Abu Dhabi</h2></div>
                   </div>
                   <div className="min-w-[140px] w-[140px] h-[170px] sm:w-[160px] sm:h-[200px] md:w-[230px] md:h-[280px] rounded-lg overflow-hidden relative ">
                       <img src={img3} alt="" className="w-full h-full object-cover" />
                       <div className="absolute w-full h-full bottom-0 left-0 flex items-end bg-gradient-to-b from-transparent via-transparent to-black"><h2 className="text-white text-[16px] pb-3 px-3 pl-4 w-full hover:text-[18px] transition-all md:text-xl md:hover:text-2xl GTE_light">Dubai</h2></div>
                   </div>
                   <div className="min-w-[140px] w-[140px] h-[170px] sm:w-[160px] sm:h-[200px] md:w-[230px] md:h-[280px] rounded-lg overflow-hidden relative ">
                       <img src={img1} alt="" className="w-full h-full object-cover" />
                       <div className="absolute w-full h-full bottom-0 left-0 flex items-end bg-gradient-to-b from-transparent via-transparent to-black"><h2 className="text-white text-[16px] pb-3 px-3 pl-4 w-full hover:text-[18px] transition-all md:text-xl md:hover:text-2xl GTE_light">Raj Sthan</h2></div>
                   </div>
                   <div className="min-w-[140px] w-[140px] h-[170px] sm:w-[160px] sm:h-[200px] md:w-[230px] md:h-[280px] rounded-lg overflow-hidden relative ">
                       <img src={img1} alt="" className="w-full h-full object-cover" />
                       <div className="absolute w-full h-full bottom-0 left-0 flex items-end bg-gradient-to-b from-transparent via-transparent to-black"><h2 className="text-white text-[16px] pb-3 px-3 pl-4 w-full hover:text-[18px] transition-all md:text-xl md:hover:text-2xl GTE_light">Raj Sthan</h2></div>
