...
const TourDetails = () => {
  ...
  return (
    <div className="pb-16 text-richblue-700">
      ...
      <motion.div drag={"y"} dragSnapToOrigin={{
        y:true
      }} dragConstraints={{
      ...
      transition={{duration:.8, delay:.2}}
       className="bg-white relative z-50 overflow-hidden">
        <div className="max-h-screen min-h-fit">
          ...
          <div className="fixed bottom-0 w-full bg-white py-3  z-[999] flex gap-x-2 items-stretch px-4 max-w-maxContent mx-auto -mt-0 md:-mt-5 left-1/2 -translate-x-1/2 shadow-[0_0_20px_rgba(0,0,0,0.2)] GTE_light">
            <button
              ...
              onClick={() => {
                ...
                dispatch(
                  setBookingData({ key: "destination", value: "Dubai Safari" })
                );
