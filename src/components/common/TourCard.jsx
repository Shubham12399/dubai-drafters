    ...
    <>
     <div className="min-w-[140px] w-[130px] sm:w-[160px] md:min-w-[170px] md:w-[170px] rounded-xl overflow-hidden relative bg-white shadow-xl ">
                            <div className="w-full">
                                <img src={tourImg} alt="" className="w-full h-[110px] sm:h-[110px] object-cover" />
                            </div>
                            <div className="px-3 sm:px-4 my-2 mb-3 sm:my-4 ">
                                <Tooltip content={tourTitle}><h3 className="text-[13px] sm:text-sm font-medium line-clamp-1">{tourTitle}</h3></Tooltip>
                                <h3 className="text-xs font-medium text-richblack-900 mt-1">AED {tourPrice}</h3>
