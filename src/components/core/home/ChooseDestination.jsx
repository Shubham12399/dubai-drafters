    ...
    <>
        ...
        <div className="md:mt-12 max-w-maxWidthContent mx-auto -mt-2 pl-3 md:px-6">
          ...
          <div className="flex items-start overflow-auto gap-1 py-2 hide-scrollbar font-normal GTE_light ">
            <div className="min-w-fit normal-case bg-[#ff621c] text-white text-xs rounded-full font-medium md:px-4 drop-shadow-[0_0_4px_#ff641c6a] px-2 py-1 flex items-center gap-x-1 ">
            ...
            <div className="min-w-fit w-fit px-3 py-1 text-[12px] md:text-sm hover:text-white hover:bg-[#ff621c] text-black rounded-full cursor-pointer transition-all border flex items-center gap-x-1 ">
          ...
          <div className="">
            ...
            <div className="my-3 mt-4 flex gap-x-2 md:gap-x-4 md:mt-6 overflow-auto hide-scrollbar">
