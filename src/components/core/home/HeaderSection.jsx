  ...
  return (
    <div className="w-full bg-[rgba(0,0,0,0.03)] pb-8">
      ...
      <div className=" shadow-sm mb-3">
            ...
            <div className="relative py-4 md:py-6 mb-4 px-2 pl-3 md:pl-2 max-w-maxContent mx-1 md:m-0 md:pb-9 sm:!mx-auto md:rounded-none md:shadow-none border border-[#ff621c] rounded-xl bg-white ">
